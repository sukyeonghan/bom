...
<section id="container">
	<div id="flexDiv">
		...
		<div id="admin-container">
			...
			<div class="btnFilter">
				<div class="btn-group">
					<button type="button" class="btn btn-success dropdown-toggle"
						data-toggle="dropdown" style="height: 30px">골라보기</button>
				...
				<tbody>
					...
					<c:forEach items="${list}" var="q">
						<tr>
							...
							<td style="display: none"><fmt:formatDate type="both"
									timeStyle="short" value="${q.qnaAnswerDate }" /></td>
			...
			<!--1:1문의 모달창 -->
			<div class="modal fade" id="qnaView" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-body container">
							...
							<!--문의내용  -->
							<div class="form-group">
								<textarea class="form-control qContent" rows="5" readonly></textarea>
							</div>

							<!-- 상품문의 관리자 답변 내용 -->
							<form name="frm_qnaAnswer" action="${path }/admin/qnaAnswer"
								onsubmit="return fn_answerCk()">

								<div class=answerContainer>
									<strong><span>관리자 답변</span></strong>&nbsp;&nbsp;<span
										class="answerDate"></span><br>
									<div class="form-group">
										<textarea class="form-control qAnswer" rows="5"
											name="qnaAnswer" placeholder="답변을 입력해주세요."
								...
								<div class="btnBox">
									...
									<input type="hidden" class="qnaWriter" name="qnaWriter">
									<!-- 알림전송용 -->
									<input type="button"
										class="btn btn-outline-success btn-sm deleteQna "
										data-confirm="답변을 삭제하시겠습니까?" value="문의글 삭제"><br>
									<input type="submit" class="btn btn-success btn-sm insertQna "
										value="답변등록"><br> <input type="hidden"
										class="btn btn-success btn-sm editQna " value="답변수정">
...
<script>
	...
	$(".deleteQna").on(
			...
			function(e) {
				...
				if (choice) {
					let qnaNo = $(event.target).parents().children(
							'input[name=qnaNo]').val();

...
<style>
	...
	.customoverlay .title {display:block;text-align:center;background:#fff;margin-right:35px;padding:10px 15px;font-size:14px;font-weight:bold;text-decoration: none;}
	.customoverlay .title:hover{text-decoration: none;color:#45A663;}
...
<section id="container">
	<div id="intro-container">
		<!-- 상단 소개 -->
		<div id="top-intro" class="rows">
			<!-- 소개 타이틀 -->
			<div class="col-4" >
				<h3 class="font-weight-bold text-left">건강한 소비가 만드는</h3>
		...
		<!-- 소개 세부내용 -->
		<div class="rows margin15">
			<img class="align-self-center icon"
				src="${path }/resources/images/intro/sprout.png">
			<div class="col-9 sub-intro">
		...
		<div class="rows margin15">
			<img class="align-self-center icon"
				src="${path }/resources/images/intro/save.png">
			<div class=" col-9 sub-intro">
		...
		<div class="rows margin15">
			<img class="align-self-center icon"
				src="${path }/resources/images/intro/recycle.png">
			<div class="col-9 sub-intro">
		...
		<!--지점 사진  -->
		<div id="img-wrap">
			<img class="img" src="${path }/resources/images/intro/shop3.jpg" >
		</div>

	
		<!-- 엣헴이 소개 -->
		<div  id="mascot">
			<img id="mascot-img" src="${path }/resources/images/intro/mascot.png">
			<div>
				<p class="sub-content">
					<br>다시:봄의 마스코트, <br>
					<mark>엣헴이</mark>
		...
		<div class="rows">
			...
			<!-- 운영시간, 위치 설명 -->
			<div class="col-3 align-self-center sub-intro">
				<h5 class="sub-title font-weight-bold">
					<img class="bottom-img" src="${path }/resources/images/intro/clock.png">
					운영시간</h5>
				<p class="sub-content"> 
					평일 : 10:00~21:00<br>
				...
				<br>
				<h5 class="sub-title font-weight-bold">
					<img class="bottom-img" src="${path }/resources/images/intro/placeholder.png ">
					위치</h5>
				<p class="sub-content"> 
					서울시 성동구 왕십리로 115,<br>
					헤이그라운드 1층(서울숲점)

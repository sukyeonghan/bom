...
//회원검색 페이징바
	public static Object getPageBar(int totalData, int cPage, int numPerpage, String uri, String searchType,
			String keyword) {
String pageBar="";
		...
		pageBar+="<script>";
		pageBar+="function fn_paging(cPage){";
		pageBar+="location.href='"+uri+"?cPage='+cPage+'&searchType="+searchType+"&keyword="+keyword+"';";
